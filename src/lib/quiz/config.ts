...
export const STEPS: Step[] = [
...

  {
    ...
    subtitle: "As mudanças hormonais dessa fase podem influenciar a densidade e o afinamento dos fios.",
    type: "single",
    options: [
      { id: "sim", label: "Já estou na menopausa", scores: { osa: 3 }, tags: ["hormonal"] },
      { id: "peri", label: "Estou no climatério", scores: { osa: 2 }, tags: ["hormonal"] },
