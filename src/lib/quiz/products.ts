...
export const PRODUCTS: Record<string, Product> = {
  ferritin12: {
    ...
    usage: "Uso interno diário, contínuo. Resultados relatados a partir do 1º ao 3º mês.",
    url: `${BASE}ferritin12`,
    price: "R$ 135,90",
  },
  osa: {
    ...
    usage: "Uso interno diário, contínuo. Fios mais grossos relatados a partir do 2º mês.",
  ...
  tonico: {
    ...
    usage: "Aplicação tópica diária no couro cabeludo. Novos fios relatados a partir do 1º mês.",
